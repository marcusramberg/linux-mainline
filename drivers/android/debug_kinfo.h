 ...
 *
 * Layout copied from the Android common kernel's
 * drivers/android/debug_kinfo.h; it is an ABI with the Zumapro debug snapshot
 * firmware, so the field order, packing and checksum must not change.
 */
