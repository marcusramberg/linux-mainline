...
PNAME(mout_cmu_hsi0_dposc_p)	= { "oscclk", "dout_cmu_shared2_div2" };
...
static const struct samsung_mux_clock top_mux_clks[] __initconst = {
	...
	MUX(CLK_MOUT_CMU_HSI0_DPOSC, "mout_cmu_hsi0_dposc",
	    mout_cmu_hsi0_dposc_p, CLK_CON_MUX_MUX_CLKCMU_HSI0_DPOSC,
	    0, 1),
...
static const struct samsung_cmu_info top_cmu_info __initconst = {
	...
	/*
	 * No save list: this CMU is not inside a power domain (see the pd
	 * phandles in zumapro.dtsi), so nothing here loses state across sleep --
	 * a clock-gated register keeps its value. The vendor PMU-calibration
	 * table for Zuma has no *_save[] for this CMU either, and every offset
	 * we do read on a power-down has to exist: a hole in the CMU's decode
	 * raises an SError and resets the SoC.
	 */
...
/*
 * Saved and restored across a DPU power cycle. Generated, in the vendor's own
 * order, from the Zuma PMU-calibration table
 * google-modules/soc/gs/drivers/soc/google/cal-if/zuma/flexpmu_cal_local_zuma.h:
 * every PMUCAL_SAVE_RESTORE row of DPU_save[] based at this CMU. Those rows
 * are the sequence the firmware itself runs, so the offsets are the hardware's
 * and not a transcription of a register dump. No CLK_CON_GAT_* is in here: the
 * gates are hardware-controlled (auto_clock_gate), and the vendor does not save
 * them either. The domain's sysreg DRCG/MEMCLK pair is carried separately by
 * sysreg_clk_regs.
 */
...
#define PLL_CON0_MUX_CLKCMU_HSI0_DPOSC_USER						0x670
...
#define CLK_CON_GAT_CLK_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_DP_OSC_CLK			0x2040
...
#define PLL_LOCKTIME_REG_PLL_USB                                         0x0080
#define PLL_CON5_PLL_USB                                                 0x0114
#define PLL_CON6_PLL_USB                                                 0x0118
#define PLL_CON7_PLL_USB                                                 0x011c
#define PLL_CON8_PLL_USB                                                 0x0120
#define PLL_CON0_MUX_CLKCMU_HSI0_NOC_USER                                0x0620
#define PLL_CON0_MUX_CLKCMU_HSI0_USB32DRD_USER                           0x0650
...
#define CLK_CON_MUX_MUX_CLK_HSI0_I3C                                     0x100c
#define CLK_CON_MUX_MUX_CLK_HSI0_RTCCLK                                  0x1010
#define CLK_CON_MUX_MUX_CLK_HSI0_USI0                                    0x1014
#define CLK_CON_MUX_MUX_CLK_HSI0_USI1                                    0x1018
#define CLK_CON_MUX_MUX_CLK_HSI0_USI3                                    0x1020
#define CLK_CON_MUX_MUX_CLK_HSI0_USI4                                    0x1024
#define CLK_CON_DIV_DIV_CLK_HSI0_NOC_LH                                  0x1800
#define CLK_CON_DIV_DIV_CLK_HSI0_USB                                     0x1804
#define CLK_CON_DIV_DIV_CLK_HSI0_USB32DRD                                0x1808
#define CLK_CON_DIV_DIV_CLK_HSI0_EUSB                                    0x180c
#define CLK_CON_DIV_DIV_CLK_HSI0_I3C                                     0x1810
#define CLK_CON_DIV_DIV_CLK_HSI0_USI0                                    0x1814
#define CLK_CON_DIV_DIV_CLK_HSI0_USI4                                    0x1824
#define DMYQCH_CON_USB32DRD_QCH_REF                                      0x3000
#define DMYQCH_CON_I3C2_HSI0_QCH_SCLK                                    0x3004
#define QCH_CON_LH_ACEL_SI_D_HSI0_QCH                                    0x3054
#define QCH_CON_LH_AXI_MI_LG_ETR_HSI0_CU_QCH                             0x305c
#define QCH_CON_LH_AXI_MI_LP_AOC_HSI0_CU_QCH                             0x3060
#define QCH_CON_LH_AXI_MI_P_HSI0_CU_QCH                                  0x3064
#define QCH_CON_LH_AXI_SI_LD_HSI0_AOC_QCH                                0x3068
#define QCH_CON_LH_AXI_SI_LG_ETR_HSI0_CU_QCH                             0x306c
#define QCH_CON_LH_AXI_SI_LP_AOC_HSI0_CU_QCH                             0x3070
#define QCH_CON_LH_AXI_SI_P_HSI0_CU_QCH                                  0x3074
#define QCH_CON_PPMU_HSI0_QCH                                            0x3078
#define DMYQCH_CON_I3C3_HSI0_QCH_SCLK                                    0x307c
#define QCH_CON_SLH_AXI_MI_LG_ETR_HSI0_QCH                               0x3080
#define QCH_CON_SLH_AXI_MI_LP_AOC_HSI0_QCH                               0x3084
#define QCH_CON_SLH_AXI_MI_P_HSI0_QCH                                    0x3088
#define QCH_CON_SSMT_HSI0_QCH                                            0x308c
#define QCH_CON_SYSMMU_S0_HSI0_QCH_S0                                    0x3090
#define QCH_CON_DP_LINK_QCH_OSC_CLK                                      0x3094
#define QCH_CON_SYSMMU_S0_PMMU0_HSI0_QCH_S0                              0x3098
#define QCH_CON_I3C2_HSI0_QCH_PCLK                                       0x309c
#define QCH_CON_I3C3_HSI0_QCH_PCLK                                       0x30a0
#define QCH_CON_USB32DRD_QCH_EUSBPHY                                     0x30a8
#define QCH_CON_USB32DRD_QCH_USBDPPHY_CTRL                               0x30b0
#define QCH_CON_USB32DRD_QCH_USBDPPHY_TCA                                0x30b4
...
#define QCH_CON_USI0_HSI0_QCH                                            0x30c4
#define QCH_CON_USI1_HSI0_QCH                                            0x30c8
#define QCH_CON_USI2_HSI0_QCH                                            0x30cc
#define QCH_CON_USI3_HSI0_QCH                                            0x30d0
#define QCH_CON_USI4_HSI0_QCH                                            0x30d4

/*
 * Saved and restored across a HSI0 power cycle. Generated, in the vendor's own
 * order, from the Zuma PMU-calibration table
 * google-modules/soc/gs/drivers/soc/google/cal-if/zuma/flexpmu_cal_local_zuma.h:
 * every PMUCAL_SAVE_RESTORE row of HSI0_save[] based at this CMU. Those rows
 * are the sequence the firmware itself runs, so the offsets are the hardware's
 * and not a transcription of a register dump. No CLK_CON_GAT_* is in here: the
 * gates are hardware-controlled (auto_clock_gate), and the vendor does not save
 * them either. The domain's sysreg DRCG/MEMCLK pair is carried separately by
...
PNAME(mout_hsi0_dposc_user_p)		= { "oscclk",
					    "dout_cmu_hsi0_dposc" };
...
static const struct samsung_mux_clock hsi0_mux_clks[] __initconst = {
	...
	MUX(CLK_MOUT_HSI0_DPOSC_USER,
	    "mout_hsi0_dposc_user", mout_hsi0_dposc_user_p,
	    PLL_CON0_MUX_CLKCMU_HSI0_DPOSC_USER, 4, 1),
...
static const struct samsung_gate_clock hsi0_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_HSI0_DP_LINK_I_DP_OSC_CLK,
	     "gout_hsi0_dp_link_i_dp_osc_clk", "mout_hsi0_dposc_user",
...
#define PLL_CON0_MUX_CLKCMU_HSI1_ALT_USER                                0x0620
#define CLK_CON_MUX_MUX_CLK_HSI1_NOC                                     0x1000
#define CLK_CON_DIV_DIV_CLK_HSI1_NOCP                                    0x1800
#define CLK_CON_DIV_DIV_CLK_HSI1_NOC_LH                                  0x1804
#define CLK_CON_DIV_CLK_HSI1_ALT                                         0x1808
#define DMYQCH_CON_PCIE_GEN3_0_QCH_REF                                   0x3000
#define QCH_CON_SYSMMU_S0_PMMU0_HSI1_QCH_S0                              0x3004
#define QCH_CON_D_TZPC_HSI1_QCH                                          0x3034
#define QCH_CON_GPC_HSI1_QCH                                             0x3038
#define QCH_CON_HSI1_CMU_HSI1_QCH                                        0x3040
#define QCH_CON_LH_ACEL_SI_D_HSI1_QCH                                    0x3044
#define QCH_CON_LH_AXI_MI_LP_AOC_HSI1_CU_QCH                             0x3048
#define QCH_CON_LH_AXI_MI_P_HSI1_CU_QCH                                  0x304c
#define QCH_CON_LH_AXI_MI_LP_CPUCL0_HSI1_CU_QCH                          0x3050
#define QCH_CON_LH_AXI_SI_LD_HSI1_AOC_QCH                                0x3054
#define QCH_CON_LH_AXI_SI_LP_AOC_HSI1_CU_QCH                             0x3058
#define QCH_CON_LH_AXI_SI_P_HSI1_CU_QCH                                  0x305c
#define QCH_CON_LH_AXI_SI_LP_CPUCL0_HSI1_CU_QCH                          0x3060
#define QCH_CON_PCIE_GEN3_0_QCH_APB                                      0x3064
#define QCH_CON_PCIE_GEN3_0_QCH_AXI                                      0x306c
#define QCH_CON_PCIE_GEN3_0_QCH_DBI                                      0x3074
#define QCH_CON_PCIE_GEN3_0_QCH_PCS_APB                                  0x307c
#define QCH_CON_PCIE_GEN3_0_QCH_PMA_APB                                  0x3080
#define QCH_CON_PCIE_GEN3_0_QCH_UDBG                                     0x3084
#define QCH_CON_PCIE_IA_GEN3A_0_QCH                                      0x3088
#define QCH_CON_PPMU_HSI1_QCH                                            0x3090
#define QCH_CON_SLH_AXI_MI_LP_AOC_HSI1_QCH                               0x309c
#define QCH_CON_SLH_AXI_MI_P_HSI1_QCH                                    0x30a0
#define QCH_CON_LH_AXI_MI_LP_CPUCL0_HSI1_QCH                             0x30a4
#define QCH_CON_SSMT_HSI1_QCH                                            0x30a8
#define QCH_CON_SSMT_PCIE_IA_GEN3A_0_QCH                                 0x30ac
#define QCH_CON_SYSMMU_S0_HSI1_QCH_S0                                    0x30b4
#define QCH_CON_SYSREG_HSI1_QCH                                          0x30bc
#define QCH_CON_UASC_PCIE_GEN3A_DBI_0_QCH                                0x30c0
#define QCH_CON_UASC_PCIE_GEN3A_SLV_0_QCH                                0x30c4

/*
 * Saved and restored across a HSI1 power cycle. Generated, in the vendor's own
 * order, from the Zuma PMU-calibration table
 * google-modules/soc/gs/drivers/soc/google/cal-if/zuma/flexpmu_cal_local_zuma.h:
 * every PMUCAL_SAVE_RESTORE row of HSI1_save[] based at this CMU. Those rows
 * are the sequence the firmware itself runs, so the offsets are the hardware's
 * and not a transcription of a register dump. No CLK_CON_GAT_* is in here: the
 * gates are hardware-controlled (auto_clock_gate), and the vendor does not save
 * them either. The domain's sysreg DRCG/MEMCLK pair is carried separately by
